             ...
             <div className="border shadow-sm rounded-3">
                ...
                <div className="d-flex TrainerCard-details py-2 px-2">
                    <div className="col-7">
                        ...
                        <h4 className=" theme-color fw-bold mt-2">₹{Tdata.fees}/ <span className="h6 fw-normal">session</span></h4>
                    </div>
                    <div className="col-5 d-flex justify-content-end pe-3">
                        <Link to="BookingForm" > 
                            <button  className=" btn theme-bgcolor  text-white rounded-pill my-auto px-3">BOOK</button>
                        </Link>
                    </div>
                </div>
            </div>
